...
<head>
    ...
    <title>Library | LockScreen</title>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p class="centered"><img class="img-circle" width="80" src="{{asset('user-assets/img/ui-sam.jpg')}}"></p>
...
<script>
    $.backstretch( "{{ asset('user-assets/img/books.jpg')}}", {speed: 500});
</script>
