...
<head>
    ...
    <!-- iCheck -->
    <link href="{{ asset('admin_template/plugins/iCheck/square/blue.css') }}" rel="stylesheet" type="text/css" />
    ...
    <div class="login-box-body">
        ...
        <form action="{{ route('adminlogin') }}" method="post">
            <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="Username" name="username" value="{{ Input::old('username') }}"/>
